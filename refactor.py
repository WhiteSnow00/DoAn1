...
def create_main_window():
    def about():
        hide_all_frames()
        about_frame.pack()
        label = ttk.Label(about_frame, text='Author: Lê Minh Tuấn - Nguyễn Kim Cương')
        label.pack(ipady=10)
    ...
    def manage_book():
        ...
        label = ttk.Label(book_frame, text='This is a label')
        label.pack(ipady=10)

        textbox = ttk.Entry(book_frame, textvariable=text, show='*')
        textbox.focus()
        textbox.pack()
    ...
    menubar.add_cascade(label='Quản lý danh mục', menu=category_menu)
    category_menu.add_command(label='Quản lý nhà xuất bản', command=no_func)
    category_menu.add_command(label='Quản lý tác giả', command=no_func)
    category_menu.add_command(label='Quản lý thể loại sách', command=no_func)
    category_menu.add_command(label='Quản lý vị trí giá sách', command=no_func)
